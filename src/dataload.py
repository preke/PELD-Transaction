...
def load_data(args, DATA_PATH):
    ...
    uttr_vad = [[uttr_vad_1[i][0]*0.1 + uttr_vad_2[i][0]*0.9, 
                 uttr_vad_1[i][1]*0.1 + uttr_vad_2[i][1]*0.9,
                 uttr_vad_1[i][2]*0.1 + uttr_vad_2[i][2]*0.9] for i in range(len(uttr_vad_1))]
